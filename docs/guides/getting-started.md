...
It allows you to deploy or redeploy Windows and Linux operating systems directly from an existing VPS without using rescue mode, VNC consoles, or manual installation procedures.
